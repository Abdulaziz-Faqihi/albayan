...
build_exe_options = {
    ...
    "packages": ["core_functions", "theme", "ui", "utils", "wx"],
    "includes": ["wx", "wx.adv", "packaging", "requests", "UniversalSpeech", "sqlalchemy", "sqlalchemy.dialects.sqlite", "apscheduler"],
...
# Cleanup is handled by cx_Freeze
